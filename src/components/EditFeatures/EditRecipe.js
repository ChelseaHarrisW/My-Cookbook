// this module is responsible for handling the form edits
...
export const EditRecipe = (props) => {
    //define state variable that will store all that changes needed to edit the form.
        ...
        const [changeRecipe, setChangedRecipe] = useState({})  // State variable for current needed to changeRecipe object
